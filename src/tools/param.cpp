...
namespace Toolbox
{
    ...
    // Constants
    // -------------------------------
    const std::string ParameterTool::CLASS_PREFIX = "Toolbox::Parameter::";


    // Check Parameter Member
    // -------------------------------
    bool ParameterTool::checkMember(
    ...
    // -------------------------------
    bool ParameterTool::checkDataType(
        const XmlRpc::XmlRpcValue& param, 
    ...
    // -------------------------------
    std::string ParameterTool::getParamTypeName(
