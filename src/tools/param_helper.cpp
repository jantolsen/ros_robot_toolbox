...
namespace Toolbox
{
// Parameter Helper Class - Members:
// -------------------------------

    // Constants
    // -------------------------------
    const std::string ParameterHelper::CLASS_PREFIX = "Toolbox::ParameterHelper::";

    // Check Parameter Helper Member
    // -------------------------------
    bool ParameterHelper::checkMember(
    ...
    // -------------------------------
    bool ParameterHelper::checkDataType(
        const XmlRpc::XmlRpcValue& param, 
    ...
    // -------------------------------
    bool ParameterHelper::checkSize(
        const XmlRpc::XmlRpcValue& param, 
        const int& size)
    {
    ...
    // -------------------------------
    std::string ParameterHelper::getParamTypeName(
        const XmlRpc::XmlRpcValue& param)
    {
